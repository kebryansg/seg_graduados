        ...
        $.post("servidor/sConfiguracion.php",
                ...
                function (response) {
                    ...
                    for (var clave in datos) {
                        $("[name='" + clave.toLowerCase() + "']").html(datos[clave]);
                    }
                });
